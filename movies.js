...
const getDailyMovie = function(callback){
  ...
  var movieURL = 'https://api.themoviedb.org/3/discover/movie?api_key=' + credentials.movieDB;
...
var weeklyNewMovieURL = 'https://api.themoviedb.org/3/discover/movie?api_key=' + credentials.movieDB + '&with_release_type=2|3&region=US';
